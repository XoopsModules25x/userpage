<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_USERPAGE_HELP_HEADER}>
    ...
    - You can activate RSS feeds to list the recent pages<br>
    - For each user's page, you have a printable and a Pdf version.<br>
    - The module gives you 3 blocks : Last pages, Top viewed pages, Random pages<br>
    - The 3 blocks provide you an "on the fly" method so that you can use the blocks as many times as you want<br>
    - Users pages can be commented<br>
    - In the module's options, you can select if you want to activate Html, RSS feeds (and the text's length), you can also select the date's format and you can select the Editor to use .<br><br><br>
    <strong><span style="text-decoration: underline;">Limitations</span></strong><br>
    For this moment users can only create one page<br><br><br>
