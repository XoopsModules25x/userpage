...
define('_USERPAGE_EMPTY_PAGE', 'La pagina � vuota');
define('_USERPAGE_DB_OK', 'Il database � stato aggiornato');
...
define('_USERPAGE_THISCOMESFROM', 'Questa pagina � stata creata da %s');
define('_USERPAGE_URLFORPAGE', "L'indirizzo di questa pagina �: ");
