...
/** @var \XoopsModules\Userpage\Utility $utility */
$db      = \XoopsDatabaseFactory::getDatabaseConnection();
$debug   = false;
$helper  = \XoopsModules\Userpage\Helper::getInstance($debug);
$utility = new \XoopsModules\Userpage\Utility();
//$configurator = new Userpage\Common\Configurator();

$helper->loadLanguage('common');

//handlers
//$categoryHandler     = new Userpage\CategoryHandler($db);
//$downloadHandler     = new Userpage\DownloadHandler($db);
