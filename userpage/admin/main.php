...
//        userpage_adminmenu(0);
		...
		foreach($pages as $page) {
			...
			echo "<td><a href=\"".XOOPS_URL."/modules/userpage/main.php?page_id=".$page->getVar('up_pageid')."\">".$page->getVar('up_title')."</a></td>";
			...
			$del_action = "<a title='"._DELETE."' href='main.php?op=delete&id=".$page->getVar('up_pageid')."' ".userpage_utils::javascriptLinkConfirm(_USERPAGE_ARE_YOU_SURE)." ><img src='../images/delete.gif' alt='"._DELETE."' border='0' /></a>";
...
//		echo "<br /><div align='center'><a href='http://xoops.instant-zero.com' target='_blank'><img src='../images/instantzero.gif'></a></div>";
	...
	case 'delete':
		...
		if($res) {
			...
			redirect_header('main.php', 2, _USERPAGE_DB_OK);
			exit();
		} else {
			redirect_header('main.php', 4, _ERRORS);
			exit();
		}
		break;
}
